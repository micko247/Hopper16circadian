#!/usr/bin/env python3
"""heatmap_Cvi_ZT_4gene.py
--------------------------
As heatmap_Cvi_ZT.py but retaining only 4 genes:
ELF3a, ELF4a, LUX1a, PHYB

Output  : circadian_heatmap_Cvi_ZT_4gene.png  (180 dpi)
          circadian_heatmap_Cvi_ZT_4gene.pdf
"""
...
# ── Save ──────────────────────────────────────────────────────────────────────
for fname in ('circadian_heatmap_Cvi_ZT_4gene.png', 'circadian_heatmap_Cvi_ZT_4gene.pdf'):
