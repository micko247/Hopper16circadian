#!/usr/bin/env python3
"""heatmap_CviRam_ZT_5gene.py
-----------------------------
As heatmap_CviRam_ZT_4gene.py with PHYB (VIT_05s0077g00940) added.

Genes   : ELF3a, ELF4a, LUX1a, PCH1, PHYB
Genotypes: V.vi (top row), Ramsey (bottom row) per gene panel
Columns : ZT4, ZT5, ZT6, ZT8, ZT12
          (raw times 24 h, 1 h, 2 h, 4 h, 8 h)

Output  : circadian_heatmap_CviRam_ZT_5gene.png  (180 dpi)
          circadian_heatmap_CviRam_ZT_5gene.pdf
"""
...
GENES = [
    ...
    dict(
        short      = 'PCH1',
        Cab = [12.2988, 12.0462, 11.7368, 11.9148, 12.5086],
        Ram = [12.1026, 11.9340, 12.1177, 11.9188, 12.0666],
        q_time     = 1.15e-6,
        q_culttime = 2.43e-2,
    ),
    dict(
...
# ── Save ──────────────────────────────────────────────────────────────────────
for fname in ('circadian_heatmap_CviRam_ZT_5gene.png', 'circadian_heatmap_CviRam_ZT_5gene.pdf'):
