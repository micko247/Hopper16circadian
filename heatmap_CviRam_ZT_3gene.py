#!/usr/bin/env python3
"""heatmap_CviRam_ZT_3gene.py
-----------------------------
Heatmap of 3 circadian candidate genes in control conditions for
V.vi (Cabernet Sauvignon) and Ramsey, with ZT-labelled columns.

Genes   : ELF3a, ELF4a, LUX1a
Genotypes: V.vi (top row), Ramsey (bottom row) per gene panel
Columns : ZT4, ZT5, ZT6, ZT8, ZT12
          (raw times 24 h, 1 h, 2 h, 4 h, 8 h)

Output  : circadian_heatmap_CviRam_ZT_3gene.png  (180 dpi)
          circadian_heatmap_CviRam_ZT_3gene.pdf
"""
...
# ── Save ──────────────────────────────────────────────────────────────────────
for fname in ('circadian_heatmap_CviRam_ZT_3gene.png', 'circadian_heatmap_CviRam_ZT_3gene.pdf'):
