...
"""heatmap_Cvi_ZT.py
--------------------
As heatmap_Cvi.py but with columns reordered and relabelled to
Zeitgeber time (ZT):

  Raw time point  →  ZT label
  24 h            →  ZT4
   1 h            →  ZT5
   2 h            →  ZT6
   4 h            →  ZT8
...
Column order (left→right): ZT4, ZT5, ZT6, ZT8, ZT12
Data array index order   :  [4,   0,   1,   2,   3 ]

Output  : circadian_heatmap_Cvi_ZT.png  (180 dpi)
          circadian_heatmap_Cvi_ZT.pdf
"""
...
# Z-score computed across all 5 values first, then columns are reordered.
...
# ── Save ──────────────────────────────────────────────────────────────────────
for fname in ('circadian_heatmap_Cvi_ZT.png', 'circadian_heatmap_Cvi_ZT.pdf'):
